...
Personal blog of **Zaimokuza**. A quote-led opening, open-source works, an observatory for followed repositories, and an experience timeline in one warm, quiet page.
...
Cards on 开源作品 carry a commit-activity sparkline, a language composition bar, cumulative commits, contributors, forks, open issues, and the latest release; the `最近提交` date appears in the observatory only. The data has two layers:
